...
export const seedDatabase = async () => {
  try {
    ...
    await CampusGuide.insertMany([
      { name: 'Central Library', category: 'library', location: 'Main Academic Block', building: 'Block A', floor: '2nd Floor', roomNumber: '201', timings: '08:00 AM - 08:00 PM', description: 'Access over 50,000 reference books, digital archives, and quiet study pods.', imageUrl: 'https://images.unsplash.com/photo-1521587760476-6c12a4b040da?w=800&auto=format&fit=crop&q=80' },
      { name: 'Advanced Computer Lab 1', category: 'lab', location: 'IT Wing', building: 'Block B', floor: '1st Floor', roomNumber: '104', timings: '08:30 AM - 05:30 PM', description: 'High-performance computing laboratory equipped with 60 workstations and high-speed fiber internet.', imageUrl: 'https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=800&auto=format&fit=crop&q=80' },
      { name: 'Science & Electronics Lab', category: 'lab', location: 'Science Wing', building: 'Block C', floor: 'Ground Floor', roomNumber: '002', timings: '09:00 AM - 05:00 PM', description: 'State-of-the-art physics, chemistry, and electronics testing equipment.', imageUrl: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?w=800&auto=format&fit=crop&q=80' },
      { name: 'Main Auditorium', category: 'academic', location: 'Campus Grounds', building: 'Auditorium Complex', floor: 'Ground Floor', roomNumber: 'AUD-1', timings: 'Event Based', description: 'Air-conditioned 1,200 seat theater with 4K projection and acoustic sound system.', imageUrl: 'https://images.unsplash.com/photo-1511578314322-379afb476865?w=800&auto=format&fit=crop&q=80' },
      { name: 'Student Canteen', category: 'canteen', location: 'Student Plaza', building: 'Plaza Center', floor: 'Ground Floor', roomNumber: 'CN-1', timings: '07:30 AM - 07:00 PM', description: 'Hygienic multi-cuisine cafeteria providing fresh meals, beverages, and snacks.', imageUrl: 'https://images.unsplash.com/photo-1567521464027-f127ff144326?w=800&auto=format&fit=crop&q=80' },
      { name: 'Administration Office', category: 'admin', location: 'Main Administrative Building', building: 'Block A', floor: 'Ground Floor', roomNumber: '101', timings: '09:30 AM - 04:30 PM', description: 'College registrar, fee collection counters, and general inquiries.', imageUrl: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&auto=format&fit=crop&q=80' },
      { name: 'Examination Cell', category: 'admin', location: 'Administrative Block', building: 'Block A', floor: '1st Floor', roomNumber: '112', timings: '10:00 AM - 04:00 PM', description: 'Official hall ticket issuance, grade transcript verification, and re-evaluation applications.', imageUrl: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&auto=format&fit=crop&q=80' },
      { name: 'Placement Cell', category: 'services', location: 'Placement Building', building: 'Block D', floor: '3rd Floor', roomNumber: '305', timings: '09:00 AM - 05:00 PM', description: 'Corporate recruitment desk, interview rooms, and career guidance center.', imageUrl: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&auto=format&fit=crop&q=80' },
      { name: 'Student Help Desk', category: 'services', location: 'Student Activity Center', building: 'Block B', floor: 'Ground Floor', roomNumber: '010', timings: '09:00 AM - 05:00 PM', description: 'First point of contact for service requests, bonafide certificates, and lost-and-found.', imageUrl: 'https://images.unsplash.com/photo-1531545514256-b1400bc00f31?w=800&auto=format&fit=crop&q=80' },
      { name: 'Sports Complex & Gymnasium', category: 'sports', location: 'South Campus', building: 'Sports Complex', floor: 'Ground Floor', roomNumber: 'SP-1', timings: '06:00 AM - 07:00 PM', description: 'Indoor basketball court, badminton courts, table tennis, and modern fitness gym.', imageUrl: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=800&auto=format&fit=crop&q=80' },
      { name: 'Central Academic Block', category: 'academic', location: 'North Quadrangle', building: 'Main Tower', floor: '1st - 5th Floor', roomNumber: '101-510', timings: '08:00 AM - 06:00 PM', description: 'Primary lecture halls, smart classrooms, and faculty offices.', imageUrl: 'https://images.unsplash.com/photo-1541829070764-84a7d30dd3f3?w=800&auto=format&fit=crop&q=80' },
      { name: 'Student Hostels', category: 'hostel', location: 'East Campus Quarter', building: 'Hostel Complex A & B', floor: '1st - 4th Floor', roomNumber: 'H101-H420', timings: '06:00 AM - 10:00 PM', description: 'Residential halls for undergraduate and postgraduate students with dining and wifi.', imageUrl: 'https://images.unsplash.com/photo-1555854877-bab0e564b8d5?w=800&auto=format&fit=crop&q=80' }
    ]);
